    ...
    def sort_incidents(self):
        ...
        for w in range(len(zhigh)):
            for x in range(len(zhigh) - 1):
                ...
                if time1 > time2:
                    zhigh.__queue[x], zhigh.__queue[x + 1] = (
                        zhigh.__queue[x + 1],
                        zhigh.__queue[x],
                    )
        ...
        for w in range(len(zmedium)):
            for x in range(len(zmedium) - 1):
                ...
                if time1 > time2:
                    zmedium.__queue[x], zmedium.__queue[x + 1] = (
                        zmedium.__queue[x + 1],
                        zmedium.__queue[x],
                    )
        ...
        for w in range(len(zlow)):
            for x in range(len(zlow) - 1):
                ...
                if time1 > time2:
                    zlow.__queue[x], zlow.__queue[x + 1] = (
                        zlow.__queue[x + 1],
                        zlow.__queue[x],
                    )
...
if __name__ == "__main__":
    ...
    new_incident = Incident(
        "Test incident", "low", (50.00983746, 19.891731), "Victor Grahm"
    )
    ...
    print("---------- wyświetlanie za pomocą __str__ po sortowaniu ----------")
