...
class SalaKinowa:
    ...
    def zarezerwuj(self, miejsce, imie_nazwisko):
        ...
        if imie_nazwisko in self.rezerwacje_uzytkownikow:
            ...
            raise UzytkownikJuzZarezerwowalException(f"Uzytkownik {imie_nazwisko} ma juz zarezerwowane miejsce {self.rezerwacje_uzytkownikow[imie_nazwisko]}.")
    ...
    def anuluj_rezerwacje(self, miejsce, imie_nazwisko):
        ...
        if self.miejsca[miejsce]['uzytkownik'] != imie_nazwisko:
            ...
            raise NieprawidlowaAnulacjaException(f"Rezerwacja na miejscu {miejsce} nie nalezy do uzytkownika {imie_nazwisko}.")
